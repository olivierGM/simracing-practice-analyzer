...
const DRIVER_TO_TEAM = {
  ...
  'Olivier Lagacé': 'VNET',
  'Peter Gifford': 'Red Clover Motorsports',
  'Philippe Guitard': 'LimitRacing',
  'Steve St-Ours': "Driver's Squad Performance",
  'Steven Pacheco': 'Pork Chop',
  'Victor Plourde': "Driver's Squad Performance",
  'Vincent Dubuc': 'KB&VD',
  'Vincent Roy': 'VNET',
  'Zachary Boudreault': "Driver's Squad Performance",
  'Julien Pichette': 'U8R',
