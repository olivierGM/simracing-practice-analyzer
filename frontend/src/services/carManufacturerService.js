...
// Tous les logos sont hébergés localement en SVG (téléchargés depuis worldvectorlogo)
const CAR_MODEL_TO_MANUFACTURER = {
  // GT3 Cars
  0: { name: 'Porsche', logoUrl: '/logos/porsche.svg', fullName: 'Porsche 991 GT3 R' },
  1: { name: 'Mercedes', logoUrl: '/logos/mercedes.svg', fullName: 'Mercedes-AMG GT3' },
  2: { name: 'Ferrari', logoUrl: '/logos/ferrari.svg', fullName: 'Ferrari 488 GT3' },
  ...
  5: { name: 'McLaren', logoUrl: '/logos/mclaren.svg', fullName: 'McLaren 650S GT3' },
  ...
  9: { name: 'Porsche', logoUrl: '/logos/porsche.svg', fullName: 'Porsche 991II GT3 Cup' },
  ...
  14: { name: 'Jaguar', logoUrl: '/logos/jaguar.svg', fullName: 'Jaguar G3' },
  15: { name: 'Lexus', logoUrl: '/logos/lexus.svg', fullName: 'Lexus RC F GT3' },
  ...
  22: { name: 'McLaren', logoUrl: '/logos/mclaren.svg', fullName: 'McLaren 720S GT3 (2019)' },
  23: { name: 'Porsche', logoUrl: '/logos/porsche.svg', fullName: 'Porsche 911II GT3 R (2019)' },
  24: { name: 'Ferrari', logoUrl: '/logos/ferrari.svg', fullName: 'Ferrari 488 GT3 Evo 2020' },
  ...
  32: { name: 'Ferrari', logoUrl: '/logos/ferrari.svg', fullName: 'Ferrari 296 GT3' },
  33: { name: 'Lamborghini', logoUrl: '/logos/lamborghini.svg', fullName: 'Lamborghini Huracan Evo2' },
  34: { name: 'Porsche', logoUrl: '/logos/porsche.svg', fullName: 'Porsche 992 GT3 R' },
  35: { name: 'McLaren', logoUrl: '/logos/mclaren.svg', fullName: 'McLaren 720S GT3 Evo 2023' }
};
